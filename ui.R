    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               checkboxInput(inputId = "is_stacked", "Is stacked"),     # if the bars "is_stacked" (input ID), that is, if the checkbox is checked then the bars will be stacked. Otherwise, they will be faceted and unstacked. Add a label. The initial value can be either FALSE or TRUE. 
               )
             ),
